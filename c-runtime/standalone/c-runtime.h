...
_Noreturn void exit(int rval) { __builtin_trap(); }
...
prim_io prim_printNat(prim_nat n) { exit(1); }

prim_io prim_printString(prim_string s) { exit(1); }

prim_io prim_printBool(prim_bool b) { exit(1); }
...
int debug(const char* str) { return 0; }
