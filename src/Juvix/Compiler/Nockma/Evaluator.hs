      ...
      where
        ...
        goAnomaLibCall nonInterceptCall AnomaLibCall {..} = do
          ...
          case _anomaLibCallRef of
            AnomaLibValue l -> case l of
              AnomaRmValue v -> case v of
                RmZeroDelta -> nonInterceptCall
            AnomaLibFunction l -> case l of
              AnomaRmFunction _ -> error "Resource Machine client library functions are not supported"
              AnomaStdlibFunction f -> case f of
