...
checkPairDef :: (Members '[Builtins, Error BuiltinsError] r) => InductiveDef -> Sem r ()
checkPairDef d = do
...
checkPairConstr :: (Members '[Builtins, Error BuiltinsError] r) => VarName -> VarName -> ConstructorDef -> Sem r ()
