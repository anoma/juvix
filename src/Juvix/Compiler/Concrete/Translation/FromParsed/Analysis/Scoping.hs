...
findFieldIdx :: (Members '[Reader (RecordNameSignature 'Parsed), Error ScoperError] r) => Symbol -> Sem r Int
findFieldIdx f =
...
checkPun ::
  ( Members
      '[ Reader (RecordNameSignature 'Parsed),
         Error ScoperError,
         Reader InfoTable,
         State Scope,
         State ScoperState,
...
checkUpdateField ::
  (Members '[Reader (RecordNameSignature 'Parsed), HighlightBuilder, Error ScoperError, State Scope, State ScoperState, Reader ScopeParameters, InfoTableBuilder, Reader InfoTable, NameIdGen, Reader Package] r) =>
...
checkUpdateField = \case
  ...
  RecordUpdateFieldPun a -> RecordUpdateFieldPun <$> checkPun a
