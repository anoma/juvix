...
import MiniJuvix.Syntax.MiniHaskell.Language qualified as H
...
goModuleBody ::
  Members '[Error Err, Reader InfoTable] r =>
  ModuleBody ->
  Sem r H.ModuleBody
